$(document).ready((function() {
    ...
    setTimeout(function() { $('.hexpic').fadeTo(250, 1); }, 500);
    setTimeout(function() { $('.hex1').fadeTo(250, 1); }, 500);
    setTimeout(function() { $('.hex10').fadeTo(250, 1); }, 500);
    setTimeout(function() { $('.hex4').fadeTo(250, 1); }, 500);
    setTimeout(function() { $('.hex9').fadeTo(250, 1); }, 500);
    setTimeout(function() { $('.hex2').fadeTo(250, 1); }, 500);
    setTimeout(function() { $('.hex8').fadeTo(250, 1); }, 500);
    setTimeout(function() { $('.hex5').fadeTo(250, 1); }, 500);
    setTimeout(function() { $('.hex6').fadeTo(250, 1); }, 500);
    setTimeout(function() { $('.hex7').fadeTo(250, 1); }, 500);
    setTimeout(function() { $('.hex3').fadeTo(250, 1); }, 500);
    setTimeout(function() { $('.hexX').fadeTo(150, 1); }, 500);
    ...
    $('.hexpic').click(function(){
        $('.hexpic').css("transform", "scale(.5,.5)");
        setTimeout(function() {releaseDown2(); }, 150);
    })
